  ...
  return (
    <main className="flex h-screen w-screen flex-col items-center justify-center gap-4 overflow-hidden">
      <section className="flex text-[1.2rem]">
        <div className="px-4 first:border-r first:border-solid first:border-(--theme-text-description)">{props.code}</div>
        <div className="px-4 first:border-r first:border-solid first:border-(--theme-text-description)">{props.message}</div>
      </section>
