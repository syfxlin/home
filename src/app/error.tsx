...
export default function ErrorPage(props: ErrorPageProps) {
  ...
  const url = useMemo(() => {
    ...
    const url = new URL("https://github.com/syfxlin/home/issues/new");
  ...
  return (
    <ErrorFound code={500} message="Internal Error">
      ...
      <Link href={url} aria-label="create syfxlin/home issues" target="_blank" rel="nofollow noopener noreferrer">
        链接
      </Link>
